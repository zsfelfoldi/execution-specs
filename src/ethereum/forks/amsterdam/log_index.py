...
def index_entry_empty_node(index: U256) -> U256:
    ...
    match side:
        ...
        case GTI_ENTRY_META: # meta fields (log/block/tx, always 4 fields)
            if height > 2:
                raise AssertionError("Invalid log index tree node")
